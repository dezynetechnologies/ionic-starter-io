 ...
 *
 */
.factory('$ionicPush', ['$http', '$cordovaPush', '$ionicApp', '$ionicPushActions', '$ionicUser', '$rootScope', '$log', '$q', '$websocket',

function($http, $cordovaPush, $ionicApp, $ionicPushActions, $ionicUser, $rootScope, $log, $q, $websocket) {
  ...
  function init(options) {
    ...
    if (app.dev_push) {
      ...
      var dataStream = $websocket('ws://localhost:4730');
